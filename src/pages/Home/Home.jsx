      ...
      <section data-aos="fade-up" className={styles.home}>
        <div ref={home} className={styles.first}>
          <p>
            ...
            <span className={styles.third}>Revolutionizing Stablecoins: Experience Adaptive {'\n'} Stability with Nebula Finance's Hybrid Solution</span>
          </p>
        </div>
        <div className={styles.button}>
          <button
            onClick={(e) => {
              e.preventDefault();
              window.open('https://moonvector.io/private/nebula-finance', '_blank', 'noopener,noreferrer');
            }}
          ...
          <Modal className={styles.modal} isOpen={modalOpen} onRequestClose={() => setModalOpen(false)}>
      ...
      <section ref={about} className={styles.about}>
        <div data-aos="fade-right" className={styles.left}>
          ...
          <p className={styles.aboutInfo}>
            Introducing Nebula Finance, a new hybrid stablecoin solution blending the advantages of both algorithmic and collateralized stablecoin models. a two-token sytem- Nebula Cash (NUSD) as the
            stablecoin, and Nebula (NSH) the reward token- our protocol introduces dynamic fee.
          </p>
          {isShowMore1 && (
            <p className={styles.aboutInfo}>
              In our quest for a collateralization ratio between 110% and 150%, the Nebula Cash Protocol is set to transition from an algorithmic stablecoin to a hybrid model. Harnessing fees, taxes,
              and seigniorage rewards, our system builds collateral and encourages user participation through staking, rewards, and bond issuance mechanisms. Our inventive approach offers a robust and
              adaptive stablecoin solution, promoting long-term stability and widespread adoption in the crypto ecosystem. Get ready to experience a revolutionary stablecoin solution that achieves the
              vision it set out to become!
            </p>
          )}
        ...
        <div data-aos="fade-left" className={styles.right}>
          ...
          <p className={styles.aboutInfo}>
            We are an algo-based stable coin protocol that utilizes a 2 token system, with a road to full collateralization built in. Comprised of a complex system of price phases, stabilization
            methods, multiple taxes and incentives, it's a massive step forward in the quest for a viable algo based stable coin.
          </p>
          ...
          {isShowMore2 && (
            <p className={styles.aboutInfo}>
              Where we differ is by introducing an ecosystem of taxes and rebates, along with a slew of dynamic actionable phases, featuring variable rewards and fee distribution, that lay out a full
              roadmap to over-collateralization. What's our game plan? Bonds Seigniorage Rewards Dynamic Reward Distribution Dual Asset Staking Minting and Burning Stability Pool DEX Weighted Epoch
              Locks Increased Stable Lock Ratio Tax Backed Collateral Share Incentivized Tax Rebates 6 Action Phase reward Structure Roadmap to Collateralization Dex Listing Loans And much much
              more....{' '}
            </p>
          )}
          <div className={styles.howRow}>
            <a style={{ textDecoration: 'none' }} href={require('../../assets/file/nebula.pdf')} download="Nebula" className={styles.howbtn2}>
              Download PDF
            </a>
